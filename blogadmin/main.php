              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Telah di publikasi</strong></p>
                  </div>
                </div>
              </div>
              <a href="blogs_view.php">
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Dalam Penulisan</strong></p>
                  </div>
                </div>
              </div>
              <a href="#">
...
<footer class="footer footer-inverse">
      <div class="container">
        <div class="text-center">
          <small>Blog Admin 2022 | Brought To You By Hamba Allah</small>
        </div>
      </div>
    </footer>
  </body>
